...
! function(e) {
 ...
 e(window).load(function() {
  ...
  i = !!/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent), t(), e(window).scroll(function() {
   ...
   animation: "fade",
   prevText: '<i class="fa fa-chevron-left icons"></i>',
   nextText: '<i class="fa fa-chevron-right icons"></i>',
   before: function(t) {
  ...
  r = e(".product-slider"), r.owlCarousel({
   ...
   navigationText: ['<i class="fa fa-chevron-left icons"></i>', '<i class="fa fa-chevron-right icons"></i>']
  });
  var l = e("#filters"),
   c = e("#works-grid"),
   d = "masonry";
